...
pacstrap /mnt base base-devel dialog dhcpcd wpa_supplicant git vim
genfstab -U /mnt >> /mnt/etc/fstab

curl https://raw.githubusercontent.com/PaulSt/archsetup/master/dellbl.sh > /mnt/bootloader.sh 
curl https://raw.githubusercontent.com/PaulSt/archsetup/master/archsetup.sh > /mnt/chroot.sh 

arch-chroot /mnt bash bootloader.sh && bash chroot.sh && rm /mnt/chroot.sh
